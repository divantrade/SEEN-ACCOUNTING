...
function getMovementTypeFromNature_(natureType) {
    ...
    // ملاحظة: "تمويل" يجب أن يكون مدين استحقاق (دين علينا) بشرط ألا يكون "سداد تمويل" أو "استلام تمويل"
    const isDebit =
        nature.indexOf('استحقاق مصروف') !== -1 ||
        nature.indexOf('استحقاق إيراد') !== -1 ||
        (nature.indexOf('تمويل') !== -1 && nature.indexOf('سداد تمويل') === -1 && nature.indexOf('استلام تمويل') === -1) ||
        nature.indexOf('سداد تمويل') !== -1 ||
        nature.indexOf('تأمين مدفوع للقناة') !== -1;
    ...
    const isCredit =
        ...
        nature.indexOf('استرداد تأمين') !== -1;

...
/**
 * تحديث معادلات القيمة بالدولار (M) والرصيد (O) على البيانات الموجودة
 * هذه الدالة تعيد تطبيق المعادلات على جميع الصفوف الموجودة
 */
function refreshValueAndBalanceFormulas() {
  ...
  ui.alert(
    '✅ تم تحديث معادلات القيمة والرصيد',
    'تم تطبيق المعادلات على الأعمدة M و O لجميع الصفوف.\n\n' +
    '📋 المنطق:\n' +
    '• القيمة بالدولار (M):\n' +
    '   - لو العملة USD أو دولار أو فارغة → نفس قيمة المبلغ (J)\n' +
    '   - لو العملة غير ذلك → المبلغ × سعر الصرف (J × L)\n\n' +
    '• الرصيد (O):\n' +
